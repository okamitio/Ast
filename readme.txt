...
"編集→範囲指定"で切取やコピー、削除をする範囲を指定できます。
"編集→貼付"で切り取ったりコピーしたりしたデータを貼り付けられます。テンプレートは右クリックで時計回りに90度回転します。
...
設置した入力の数字をクリックすることによってその値を反転させたりできます。
...
"演算設置"で各種論理ゲートを設置できます。"入力数変更"でゲートの入力数を指定できます。テンプレートは右クリックで時計回りに90度回転します。

"バス"で複数の導線をまとめて扱う機能を使えます。

"削除"で端子、導線、モジュール、論理ゲート、バス入出力、注釈を消せます。
